...
namespace RociOS
{
    ...
    public class ConfigIO : INotifyPropertyChanged
    {
        #region Options
        ...
        public static readonly ConfigIO Default = new Config();
        public static readonly ConfigIO Current = ConfigStorage.Load();
